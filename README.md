...
<br /> •	This API will allow us to embed an interactive map into the website using simple HTTP requests
...
<br /> •	This API helps to query properties for sale, rent, sold, etc. We will use the location endpoint to get a specific property by its address.
